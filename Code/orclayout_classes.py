...
class ORCLayout(ABC):
    def __init__(self, name, parent=None, weight=1):
        super().__init__()
        ...
        # add orcwidgets to the root for later modification
        self.orcwidgets = dict()
    ...
    # add orcwidgets to the root
    def add_orcwidget(self, widget_id, widget):
        self.orcwidgets[widget_id] = widget
    ...
    def solve(self):
        ...
        print(self.constraints, self.objectives)
        print("---")
        exit()
...
class ORCWidget(ORCLayout):
    ...
    # Note: remember to call its parent's update_optional_widgets() 
...
class Pivot(ORCLayout):
    ...
    def __init__(self, name, parent=None, window_width=None, window_height=None):
        super().__init__(name, parent)
...
class Flow(ORCLayout, ABC):
    ...
    def __init__(self, name, widget_list, parent=None, balanced=False, \
        ...
        # set widget parents to be this flow
        for widget in widget_list:
            widget.flow_parent = self
    ...
    # get optional widgets in the flow
    def update_optional_widgets(self):
